        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-slate-800/80">
          ...
          <div className="lg:col-span-4 space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-slate-900 flex items-center justify-center text-white border-2 border-orange-500 shadow-sm shrink-0">
            ...
            <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
              Industrial safety accessories, personal protective equipment (PPE), and industrial material supplier with <strong className="text-slate-200">pan-India supply dispatch everywhere</strong>. Order any quantity required (from single units to bulk project supplies), plus on-demand custom sourcing for any extra specialized items.
            </p>

            <div className="flex flex-wrap items-center gap-2 pt-1">
              <span className="inline-flex items-center gap-1 text-[11px] font-bold text-amber-400 bg-slate-900 border border-amber-500/30 px-2.5 py-1 rounded-full">
            ...
            <div className="pt-2">
              <button
                ...
                className="inline-flex items-center gap-2 px-3.5 py-2 rounded-lg bg-slate-900 hover:bg-slate-800 text-xs font-bold text-amber-300 border border-slate-700 transition"
              >
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li>
                <a href="#featured" className="hover:text-orange-400 transition-colors">Featured Items</a>
              </li>
              <li>
                <a href="#pan-india" className="text-amber-400 font-bold hover:text-amber-300 transition-colors">🇮🇳 Whole India Supply & Sourcing</a>
              </li>
              <li>
                <a href="#why-us" className="hover:text-orange-400 transition-colors">Why Choose Us</a>
              </li>
              <li>
                <a href="#industries" className="hover:text-orange-400 transition-colors">Industries We Serve</a>
              </li>
              <li>
                <a href="#standards" className="hover:text-orange-400 transition-colors">Standards & Compliance</a>
              </li>
              <li>
                <a href="#projects" className="hover:text-orange-400 transition-colors">Project Supply History</a>
              </li>
              <li>
                <a href="#location" className="hover:text-orange-400 transition-colors">Location & Directions</a>
              </li>
              <li>
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-xs text-slate-400">
              ...
              <li className="flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-orange-500"></span>
                <span>Lane Marking Tape & Supplies</span>
              </li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            <div className="space-y-2.5 text-xs text-slate-300">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div className="flex flex-wrap items-center gap-1.5">
                  <a href={`tel:${COMPANY_INFO.phone}`} className="text-amber-400 hover:underline font-bold">
                    {COMPANY_INFO.phone}
                  </a>
                  <span className="text-slate-600">/</span>
                  <a href={`tel:${COMPANY_INFO.secondaryPhone}`} className="text-amber-400 hover:underline font-bold">
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full py-2 px-3 text-xs font-bold text-white bg-orange-600 hover:bg-orange-500 rounded-lg transition"
              >
