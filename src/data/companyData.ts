...
export const PRODUCTS: Product[] = [
  {
    ...
    unit: "Piece",
    availability: "Ready Stock (Mathura Warehouse)",
    moq: "1 Piece (No MOQ limit)",
  ...
  },
  {
    ...
    brand: "Karam",
    unit: "Pair",
    availability: "Ready Stock (Sizes UK/India 5-12)",
    moq: "1 Pair",
    datasheetAvailable: true,
    specifications: [
  ...
  },
  {
    ...
    isFeatured: true,
    isCardPhotoItem: true,
    sku: "AWS A5.1 E7018 / E6013",
    unit: "5 kg Packet / 20 kg Master Carton",
    availability: "Ready Stock",
    moq: "1 Packet (5 kg)",
    datasheetAvailable: true,
    specifications: [
  ...
  },
  {
    ...
    isCardPhotoItem: true,
    brand: "Champion",
    sku: "Style 20 / Style 54",
    unit: "Sheet / Pre-cut Gasket",
    availability: "Ready Stock",
    moq: "1 Sheet",
    datasheetAvailable: true,
    specifications: [
  ...
  },
  {
    ...
    isFeatured: true,
    isCardPhotoItem: true,
    sku: "ASTM A193 B7 / Grade 8.8",
    unit: "Kg / Piece / Set",
    availability: "Ready Stock (M6 - M48)",
  ...
  },
  {
    ...
    isFeatured: true,
    isCardPhotoItem: true,
    unit: "Shift / Day / Monthly Contract",
    availability: "Available on request (Booking / Contract)",
    moq: "1 Shift / Day",
    datasheetAvailable: true,
    specifications: [
  ...
  },
  {
    ...
    isFeatured: true,
    isCardPhotoItem: true,
    unit: "Sheet / Set / Dossier",
    availability: "Instant Counter Service",
