...
export const TRANSLATIONS = {
  en: {
    ...
    mapTitle: "Find Us at Mathura Refinery Main Gate",
    mapSubtitle: "Strategically located at the UP SIDC Complex opposite the Mathura Refinery Main Gate for rapid contractor pickup and doorstep site delivery.",
  ...
  hi: {
    ...
    mapTitle: "मथुरा रिफाइनरी मेन गेट पर हमारा स्थान",
    mapSubtitle: "रिफाइनरी मेन गेट के ठीक सामने UP SIDC कॉम्प्लेक्स में स्थित ताकि ठेकेदार तुरंत सामग्री ले सकें या ऑन-साइट डिलीवरी प्राप्त कर सकें।",
