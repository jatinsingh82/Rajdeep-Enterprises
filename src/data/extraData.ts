...
export const TRANSLATIONS = {
  en: {
    ...
    rfqTitle: "Procurement Cart & Checkout",
    rfqSubtitle: "Review items, adjust quantities, and request your order via WhatsApp or official email.",
    rfqEmpty: "Your Cart is empty. Add products from the catalogue below to build your order list.",
  ...
  hi: {
    ...
    rfqTitle: "सामग्री कार्ट व चेकआउट",
    rfqSubtitle: "उत्पाद की मात्रा जांचें और ईमेल या व्हाट्सएप द्वारा अपना आर्डर / कोटेशन अनुरोध भेजें।",
    rfqEmpty: "आपकी कार्ट अभी खाली है। आर्डर सूची बनाने के लिए नीचे दिए गए उत्पादों में से जोड़ें।",
